    ...
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="<?php echo base_url(); ?>assets/images/rere.jpg" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <h1>Selamat datang di Codenesia</h1>

                <h3>
                    "Kode kan hari mu dengan Codenesia" <br>
                    Codenesia merupakan Software house  <br>
                    yang di ciptakan untuk menyelesaikan  <br>
                    dan memecahkan kode kode masalah yang ada.
                </h3>
    ...
    <section id='about' class="s-about">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-1 display-1--light">We Are Codenesia</h1>
            </div>
        ...
        <div class="row about-desc" data-aos="fade-up">
            <div class="col-full">
                <p>
                  Codenesia adalah perusahaan berbasis IT (Software House) dengan berbekal semangat programmer anak muda untuk mengembangkan industri digital.
                  Perkembangan dunia bisnis saat ini tidak bisa di lepaskan dari teknologi. Bila tidak mengikuti perkembangan teknologi maka anda akan tertinggal.
                  Dengan semangat anak muda kami hadir untuk menyelesaikan masalah yang ada. "Code with love , Codenesia" .
              </p>
            </div>
        </div> <!-- end about-desc -->
    ...
    <section id='services' class="s-services">
        ...
        <div class="row section-header has-bottom-sep" data-aos="fade-up">
            <div class="col-full">
                ...
                <h1 class="display-2">Jasa dan Layanan Kami</h1>
            </div>
        </div> <!-- end section-header -->
        ...
        <div class="row services-list block-1-2 block-tab-full">
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>
                      Untuk meningkatkan pendapatan perusahaan anda , di butuhkan design yang menarik
                      agar client mempercayai perusahaana anda. Kami hadir dengan design yang menarik dan kekinian. Kami melayani
                      design website, logo , catalog dll.
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>
                      Bisnis startup digital di Indonesia diprediksikan oleh lembaga riset CHGR  akan ada 13.000 usaha rintisan yang berjalan di tahun 2020. Kami hadir untuk membantu pertumbuhan tersebut.
                      Untuk anda yang mempunyai ide bisnis startup tetapi tidak mempunyai tenaga IT , kami hadir dengan paket yang menarik untuk bekerjasama .
                    </p>
                </div>
            </div>
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>
                      Kami menyediakan layanan pemasaran sebuah brand atau produk melalui dunia digital atau internet.
                      Tujuannya ialah untuk menjangkau konsumen maupun calon konsumen secara cepat dan tepat waktu.
                      memasarkan brand tertentu melalui media internet. Bisa melalui iklan di internet, facebook, youtube,
            ...
            <div class="col-block service-item" data-aos="fade-up">
                ...
                <div class="service-text">
                    ...
                    <p>Kami menyediakan layanan pembuatan website meliputi sistem informasi keuangan ,web kasir, Company Profile, toko online, website sekolah dll.
                    </p>
                </div>
            </div>
